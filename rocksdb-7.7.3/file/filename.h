...
extern std::string DeltaLogFileName(uint64_t number);

extern std::string DeltaLogFileName(const std::string& bdirname,
                                    uint64_t number);

extern std::string DeltaLogFileName(const std::string& dbname,
                                    const std::string& deltaLog_dir,
                                    uint64_t number);
