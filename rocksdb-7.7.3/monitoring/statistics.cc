...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {DELTALOG_DB_NUM_PUT, "rocksdb.deltaLogdb.num.put"},
    {DELTALOG_DB_NUM_WRITE, "rocksdb.deltaLogdb.num.write"},
    {DELTALOG_DB_NUM_GET, "rocksdb.deltaLogdb.num.get"},
    {DELTALOG_DB_NUM_MULTIGET, "rocksdb.deltaLogdb.num.multiget"},
    {DELTALOG_DB_NUM_SEEK, "rocksdb.deltaLogdb.num.seek"},
    {DELTALOG_DB_NUM_NEXT, "rocksdb.deltaLogdb.num.next"},
    {DELTALOG_DB_NUM_PREV, "rocksdb.deltaLogdb.num.prev"},
    {DELTALOG_DB_NUM_KEYS_WRITTEN, "rocksdb.deltaLogdb.num.keys.written"},
    {DELTALOG_DB_NUM_KEYS_READ, "rocksdb.deltaLogdb.num.keys.read"},
    {DELTALOG_DB_BYTES_WRITTEN, "rocksdb.deltaLogdb.bytes.written"},
    {DELTALOG_DB_BYTES_READ, "rocksdb.deltaLogdb.bytes.read"},
    {DELTALOG_DB_WRITE_INLINED, "rocksdb.deltaLogdb.write.inlined"},
    {DELTALOG_DB_WRITE_INLINED_TTL, "rocksdb.deltaLogdb.write.inlined.ttl"},
    {DELTALOG_DB_WRITE_DELTALOG, "rocksdb.deltaLogdb.write.deltaLog"},
    {DELTALOG_DB_WRITE_DELTALOG_TTL, "rocksdb.deltaLogdb.write.deltaLog.ttl"},
    {DELTALOG_DB_DELTALOG_FILE_BYTES_WRITTEN,
     "rocksdb.deltaLogdb.deltaLog.file.bytes.written"},
    {DELTALOG_DB_DELTALOG_FILE_BYTES_READ,
     "rocksdb.deltaLogdb.deltaLog.file.bytes.read"},
    {DELTALOG_DB_DELTALOG_FILE_SYNCED,
     "rocksdb.deltaLogdb.deltaLog.file.synced"},
    {DELTALOG_DB_DELTALOG_INDEX_EXPIRED_COUNT,
     "rocksdb.deltaLogdb.deltaLog.index.expired.count"},
    {DELTALOG_DB_DELTALOG_INDEX_EXPIRED_SIZE,
     "rocksdb.deltaLogdb.deltaLog.index.expired.size"},
    {DELTALOG_DB_DELTALOG_INDEX_EVICTED_COUNT,
     "rocksdb.deltaLogdb.deltaLog.index.evicted.count"},
    {DELTALOG_DB_DELTALOG_INDEX_EVICTED_SIZE,
     "rocksdb.deltaLogdb.deltaLog.index.evicted.size"},
    {DELTALOG_DB_GC_NUM_FILES, "rocksdb.deltaLogdb.gc.num.files"},
    {DELTALOG_DB_GC_NUM_NEW_FILES, "rocksdb.deltaLogdb.gc.num.new.files"},
    {DELTALOG_DB_GC_FAILURES, "rocksdb.deltaLogdb.gc.failures"},
    {DELTALOG_DB_GC_NUM_KEYS_OVERWRITTEN,
     "rocksdb.deltaLogdb.gc.num.keys.overwritten"},
    {DELTALOG_DB_GC_NUM_KEYS_EXPIRED, "rocksdb.deltaLogdb.gc.num.keys.expired"},
    {DELTALOG_DB_GC_NUM_KEYS_RELOCATED,
     "rocksdb.deltaLogdb.gc.num.keys.relocated"},
    {DELTALOG_DB_GC_BYTES_OVERWRITTEN,
     "rocksdb.deltaLogdb.gc.bytes.overwritten"},
    {DELTALOG_DB_GC_BYTES_EXPIRED, "rocksdb.deltaLogdb.gc.bytes.expired"},
    {DELTALOG_DB_GC_BYTES_RELOCATED, "rocksdb.deltaLogdb.gc.bytes.relocated"},
    {DELTALOG_DB_FIFO_NUM_FILES_EVICTED,
     "rocksdb.deltaLogdb.fifo.num.files.evicted"},
    {DELTALOG_DB_FIFO_NUM_KEYS_EVICTED,
     "rocksdb.deltaLogdb.fifo.num.keys.evicted"},
    {DELTALOG_DB_FIFO_BYTES_EVICTED, "rocksdb.deltaLogdb.fifo.bytes.evicted"},
    ...
    {DELTALOG_DB_CACHE_MISS, "rocksdb.deltaLogdb.cache.miss"},
    {DELTALOG_DB_CACHE_HIT, "rocksdb.deltaLogdb.cache.hit"},
    {DELTALOG_DB_CACHE_ADD, "rocksdb.deltaLogdb.cache.add"},
    {DELTALOG_DB_CACHE_ADD_FAILURES, "rocksdb.deltaLogdb.cache.add.failures"},
    {DELTALOG_DB_CACHE_BYTES_READ, "rocksdb.deltaLogdb.cache.bytes.read"},
    {DELTALOG_DB_CACHE_BYTES_WRITE, "rocksdb.deltaLogdb.cache.bytes.write"}};
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {DELTALOG_DB_KEY_SIZE, "rocksdb.deltaLogdb.key.size"},
    {DELTALOG_DB_VALUE_SIZE, "rocksdb.deltaLogdb.value.size"},
    {DELTALOG_DB_WRITE_MICROS, "rocksdb.deltaLogdb.write.micros"},
    {DELTALOG_DB_GET_MICROS, "rocksdb.deltaLogdb.get.micros"},
    {DELTALOG_DB_MULTIGET_MICROS, "rocksdb.deltaLogdb.multiget.micros"},
    {DELTALOG_DB_SEEK_MICROS, "rocksdb.deltaLogdb.seek.micros"},
    {DELTALOG_DB_NEXT_MICROS, "rocksdb.deltaLogdb.next.micros"},
    {DELTALOG_DB_PREV_MICROS, "rocksdb.deltaLogdb.prev.micros"},
    {DELTALOG_DB_DELTALOG_FILE_WRITE_MICROS,
     "rocksdb.deltaLogdb.deltaLog.file.write.micros"},
    {DELTALOG_DB_DELTALOG_FILE_READ_MICROS,
     "rocksdb.deltaLogdb.deltaLog.file.read.micros"},
    {DELTALOG_DB_DELTALOG_FILE_SYNC_MICROS,
     "rocksdb.deltaLogdb.deltaLog.file.sync.micros"},
    {DELTALOG_DB_GC_MICROS, "rocksdb.deltaLogdb.gc.micros"},
    {DELTALOG_DB_COMPRESSION_MICROS, "rocksdb.deltaLogdb.compression.micros"},
    {DELTALOG_DB_DECOMPRESSION_MICROS,
     "rocksdb.deltaLogdb.decompression.micros"},
