...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {GET_HIT_L6, "rocksdb.l6.hit"},
    {GET_HIT_L2_AND_UP, "rocksdb.l2andup.hit"},
    {GET_HIT_L7_AND_UP, "rocksdb.l7andup.hit"},
    ...
    {BLOB_DB_BLOB_FILE_BYTES_READ_COUNT, "rocksdb.blobdb.blob.file.bytes.read.count"},
    ...
    {BLOB_READ_LARGE_COUNT, "blob.read.large.count"},
    {ACTUAL_READ_BYTES, "actual.read.bytes"},
    {ACTUAL_BLOB_READ_BYTES, "actual.blob.read.bytes"},
    {ACTUAL_BLOB_READ_LARGE_BYTES, "actual.blob.read.large.bytes"},
