    ...
    compaction_job_stats_type_info = {
        ...
        {"num_blobs_read",
         {offsetof(struct CompactionJobStats, num_blobs_read),
          ...
          OptionTypeFlags::kNone}},
        {"num_deltaLogs_read",
         {offsetof(struct CompactionJobStats, num_deltaLogs_read),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"num_input_files",
        ...
        {"num_output_files_blob",
         {offsetof(struct CompactionJobStats, num_output_files_blob),
          OptionType::kSizeT, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"num_output_files_deltaLog",
         {offsetof(struct CompactionJobStats, num_output_files_deltaLog),
          OptionType::kSizeT, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"is_full_compaction",
        ...
        {"total_blob_bytes_read",
         {offsetof(struct CompactionJobStats, total_blob_bytes_read),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"total_deltaLog_bytes_read",
         {offsetof(struct CompactionJobStats, total_deltaLog_bytes_read),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"total_output_bytes",
        ...
        {"total_output_bytes_blob",
         {offsetof(struct CompactionJobStats, total_output_bytes_blob),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"total_output_bytes_deltaLog",
         {offsetof(struct CompactionJobStats, total_output_bytes_deltaLog),
          OptionType::kUInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
