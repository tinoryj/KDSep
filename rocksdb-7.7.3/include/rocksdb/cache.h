...
enum class CacheEntryRole {
  ...
  kBlobCache,
  // DeltaLog value (when using the same cache as block cache and deltaLog
  // cache)
  kDeltaLogValue,
  // DeltaLog cache's charge to account for its memory usage (when using a
  // separate block cache and deltaLog cache)
  kDeltaLogCache,
