...
enum Tickers : uint32_t {
  ...
  // DeltaLogDB specific stats
  // # of Put/PutTTL/PutUntil to DeltaLogDB. Only applicable to legacy
  // DeltaLogDB.
  DELTALOG_DB_NUM_PUT,
  // # of Write to DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_WRITE,
  // # of Get to DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_GET,
  // # of MultiGet to DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_MULTIGET,
  // # of Seek/SeekToFirst/SeekToLast/SeekForPrev to DeltaLogDB iterator. Only
  // applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_SEEK,
  // # of Next to DeltaLogDB iterator. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_NEXT,
  // # of Prev to DeltaLogDB iterator. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_PREV,
  // # of keys written to DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_KEYS_WRITTEN,
  // # of keys read from DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NUM_KEYS_READ,
  // # of bytes (key + value) written to DeltaLogDB. Only applicable to legacy
  // DeltaLogDB.
  DELTALOG_DB_BYTES_WRITTEN,
  // # of bytes (keys + value) read from DeltaLogDB. Only applicable to legacy
  // DeltaLogDB.
  DELTALOG_DB_BYTES_READ,
  // # of keys written by DeltaLogDB as non-TTL inlined value. Only applicable
  // to
  // legacy DeltaLogDB.
  DELTALOG_DB_WRITE_INLINED,
  // # of keys written by DeltaLogDB as TTL inlined value. Only applicable to
  // legacy
  // DeltaLogDB.
  DELTALOG_DB_WRITE_INLINED_TTL,
  // # of keys written by DeltaLogDB as non-TTL deltaLog value. Only applicable
  // to
  // legacy DeltaLogDB.
  DELTALOG_DB_WRITE_DELTALOG,
  // # of keys written by DeltaLogDB as TTL deltaLog value. Only applicable to
  // legacy
  // DeltaLogDB.
  DELTALOG_DB_WRITE_DELTALOG_TTL,
  // # of bytes written to deltaLog file.
  DELTALOG_DB_DELTALOG_FILE_BYTES_WRITTEN,
  // # of bytes read from deltaLog file.
  DELTALOG_DB_DELTALOG_FILE_BYTES_READ,
  // # of times a deltaLog files being synced.
  DELTALOG_DB_DELTALOG_FILE_SYNCED,
  // # of deltaLog index evicted from base DB by DeltaLogDB compaction filter
  // because
  // of expiration. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_DELTALOG_INDEX_EXPIRED_COUNT,
  // size of deltaLog index evicted from base DB by DeltaLogDB compaction filter
  // because of expiration. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_DELTALOG_INDEX_EXPIRED_SIZE,
  // # of deltaLog index evicted from base DB by DeltaLogDB compaction filter
  // because
  // of corresponding file deleted. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_DELTALOG_INDEX_EVICTED_COUNT,
  // size of deltaLog index evicted from base DB by DeltaLogDB compaction filter
  // because of corresponding file deleted. Only applicable to legacy
  // DeltaLogDB.
  DELTALOG_DB_DELTALOG_INDEX_EVICTED_SIZE,
  // # of deltaLog files that were obsoleted by garbage collection. Only
  // applicable
  // to legacy DeltaLogDB.
  DELTALOG_DB_GC_NUM_FILES,
  // # of deltaLog files generated by garbage collection. Only applicable to
  // legacy
  // DeltaLogDB.
  DELTALOG_DB_GC_NUM_NEW_FILES,
  // # of DeltaLogDB garbage collection failures. Only applicable to legacy
  // DeltaLogDB.
  DELTALOG_DB_GC_FAILURES,
  // # of keys dropped by DeltaLogDB garbage collection because they had been
  // overwritten. DEPRECATED.
  DELTALOG_DB_GC_NUM_KEYS_OVERWRITTEN,
  // # of keys dropped by DeltaLogDB garbage collection because of expiration.
  // DEPRECATED.
  DELTALOG_DB_GC_NUM_KEYS_EXPIRED,
  // # of keys relocated to new deltaLog file by garbage collection.
  DELTALOG_DB_GC_NUM_KEYS_RELOCATED,
  // # of bytes dropped by DeltaLogDB garbage collection because they had been
  // overwritten. DEPRECATED.
  DELTALOG_DB_GC_BYTES_OVERWRITTEN,
  // # of bytes dropped by DeltaLogDB garbage collection because of expiration.
  // DEPRECATED.
  DELTALOG_DB_GC_BYTES_EXPIRED,
  // # of bytes relocated to new deltaLog file by garbage collection.
  DELTALOG_DB_GC_BYTES_RELOCATED,
  // # of deltaLog files evicted because of DeltaLogDB is full. Only applicable
  // to
  // legacy DeltaLogDB.
  DELTALOG_DB_FIFO_NUM_FILES_EVICTED,
  // # of keys in the deltaLog files evicted because of DeltaLogDB is full. Only
  // applicable to legacy DeltaLogDB.
  DELTALOG_DB_FIFO_NUM_KEYS_EVICTED,
  // # of bytes in the deltaLog files evicted because of DeltaLogDB is full.
  // Only
  // applicable to legacy DeltaLogDB.
  DELTALOG_DB_FIFO_BYTES_EVICTED,
  ...
  // Integrated DeltaLogDB specific stats
  // # of times cache miss when accessing deltaLog from deltaLog cache.
  DELTALOG_DB_CACHE_MISS,
  // # of times cache hit when accessing deltaLog from deltaLog cache.
  DELTALOG_DB_CACHE_HIT,
  // # of data blocks added to deltaLog cache.
  DELTALOG_DB_CACHE_ADD,
  // # of failures when adding deltaLogs to deltaLog cache.
  DELTALOG_DB_CACHE_ADD_FAILURES,
  // # of bytes read from deltaLog cache.
  DELTALOG_DB_CACHE_BYTES_READ,
  // # of bytes written into deltaLog cache.
  DELTALOG_DB_CACHE_BYTES_WRITE,
...
enum Histograms : uint32_t {
  ...
  // DeltaLogDB specific stats
  // Size of keys written to DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_KEY_SIZE,
  // Size of values written to DeltaLogDB. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_VALUE_SIZE,
  // DeltaLogDB Put/PutWithTTL/PutUntil/Write latency. Only applicable to legacy
  // DeltaLogDB.
  DELTALOG_DB_WRITE_MICROS,
  // DeltaLogDB Get latency. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_GET_MICROS,
  // DeltaLogDB MultiGet latency. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_MULTIGET_MICROS,
  // DeltaLogDB Seek/SeekToFirst/SeekToLast/SeekForPrev latency. Only applicable
  // to legacy DeltaLogDB.
  DELTALOG_DB_SEEK_MICROS,
  // DeltaLogDB Next latency. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_NEXT_MICROS,
  // DeltaLogDB Prev latency. Only applicable to legacy DeltaLogDB.
  DELTALOG_DB_PREV_MICROS,
  // DeltaLog file write latency.
  DELTALOG_DB_DELTALOG_FILE_WRITE_MICROS,
  // DeltaLog file read latency.
  DELTALOG_DB_DELTALOG_FILE_READ_MICROS,
  // DeltaLog file sync latency.
  DELTALOG_DB_DELTALOG_FILE_SYNC_MICROS,
  // DeltaLogDB garbage collection time. DEPRECATED.
  DELTALOG_DB_GC_MICROS,
  // DeltaLogDB compression time.
  DELTALOG_DB_COMPRESSION_MICROS,
  // DeltaLogDB decompression time.
  DELTALOG_DB_DECOMPRESSION_MICROS,
