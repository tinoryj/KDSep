...
struct SstFileMetaData : public FileStorageInfo {
  ...
  SstFileMetaData(const std::string& _file_name, uint64_t _file_number,
                  ...
                  uint64_t _oldest_deltaLog_file_number,
      ...
      : smallest_seqno(_smallest_seqno),
        ...
        oldest_deltaLog_file_number(_oldest_deltaLog_file_number),
  ...
  uint64_t oldest_blob_file_number = 0;
  uint64_t oldest_deltaLog_file_number = 0;
  // The id of the oldest blob file
...
// The MetaData that describes a DeltaLog file
struct DeltaLogMetaData {
  DeltaLogMetaData()
      : deltaLog_file_number(0),
        deltaLog_file_size(0),
        total_deltaLog_count(0),
        total_deltaLog_bytes(0),
  ...
  DeltaLogMetaData(uint64_t _file_number, const std::string& _file_name,
                   ...
                   const std::string& _file_checksum,
                   const std::string& _file_checksum_func_name)
      : deltaLog_file_number(_file_number),
...
struct ColumnFamilyMetaData {
  ...
  // The total size of all deltaLog files
  uint64_t deltaLog_file_size = 0;
  // The number of deltaLog files in this column family.
  size_t deltaLog_file_count = 0;
  // The metadata of the deltaLogs in this column family.
  std::vector<DeltaLogMetaData> deltaLog_files;
};
