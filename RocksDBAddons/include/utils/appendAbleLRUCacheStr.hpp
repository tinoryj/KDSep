...
//AppendAbleLRUCacheStrT::AppendAbleLRUCacheStrT(uint64_t cacheSize)
//{
//    cacheSize_ = cacheSize;
//    Cache_ = new lru_cache_str_t(cacheSize_);
//}
//
//AppendAbleLRUCacheStrT::~AppendAbleLRUCacheStrT()
//{
//    delete Cache_;
//}
//
//void AppendAbleLRUCacheStrT::insertToCache(str_t& cacheKey, value_type& data)
//{
//    std::scoped_lock<std::shared_mutex> w_lock(cacheMtx_);
//    Cache_->insert(cacheKey, data);
//}
//
//bool AppendAbleLRUCacheStrT::existsInCache(str_t& cacheKey)
//{
//    std::scoped_lock<std::shared_mutex> r_lock(cacheMtx_);
//    bool status = Cache_->contains(cacheKey);
//    if (status == true) {
...
//}
//
//value_type& AppendAbleLRUCacheStrT::getFromCache(str_t& cacheKey)
//{
//    std::scoped_lock<std::shared_mutex> r_lock(cacheMtx_);
//    value_type& newValue = Cache_->get(cacheKey);
//    return newValue;
