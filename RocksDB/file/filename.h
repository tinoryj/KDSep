...
extern std::string DeltaFileName(uint64_t number);

extern std::string DeltaFileName(const std::string& bdirname, uint64_t number);

extern std::string DeltaFileName(const std::string& dbname,
