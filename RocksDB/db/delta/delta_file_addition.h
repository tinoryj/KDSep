...
class DeltaFileAddition {
 public:
  DeltaFileAddition() = default;

  DeltaFileAddition(uint64_t delta_file_number, uint64_t total_delta_count,
 ...
 private:
  ...
  uint64_t total_delta_count_ = 0;
  uint64_t total_delta_bytes_ = 0;
