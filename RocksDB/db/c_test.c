...
int main(int argc, char** argv) {
  ...
  StartPhase("options");
  {
    ...
    /* Delta Options */
    rocksdb_options_set_enable_delta_files(o, 1);
    CheckCondition(1 == rocksdb_options_get_enable_delta_files(o));

    rocksdb_options_set_min_delta_size(o, 29);
    CheckCondition(29 == rocksdb_options_get_min_delta_size(o));

    rocksdb_options_set_delta_file_size(o, 30);
    CheckCondition(30 == rocksdb_options_get_delta_file_size(o));

    rocksdb_options_set_delta_compression_type(o, 4);
    CheckCondition(4 == rocksdb_options_get_delta_compression_type(o));

    rocksdb_options_set_enable_delta_gc(o, 1);
    CheckCondition(1 == rocksdb_options_get_enable_delta_gc(o));

    rocksdb_options_set_delta_gc_age_cutoff(o, 0.5);
    CheckCondition(0.5 == rocksdb_options_get_delta_gc_age_cutoff(o));

    rocksdb_options_set_delta_gc_force_threshold(o, 0.75);
    CheckCondition(0.75 == rocksdb_options_get_delta_gc_force_threshold(o));

    rocksdb_options_set_delta_compaction_readahead_size(o, 262144);
    CheckCondition(262144 ==
                   rocksdb_options_get_delta_compaction_readahead_size(o));

    rocksdb_options_set_delta_file_starting_level(o, 5);
    CheckCondition(5 == rocksdb_options_get_delta_file_starting_level(o));

    rocksdb_options_set_prepopulate_delta_cache(o, 1 /* flush only */);
    CheckCondition(1 == rocksdb_options_get_prepopulate_delta_cache(o));
