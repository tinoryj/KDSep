...
PerfContext::PerfContext(const PerfContext& other) {
  ...
  delta_cache_hit_count = other.delta_cache_hit_count;
  delta_read_count = other.delta_read_count;
  delta_read_byte = other.delta_read_byte;
  delta_read_time = other.delta_read_time;
  delta_checksum_time = other.delta_checksum_time;
  delta_decompress_time = other.delta_decompress_time;
...
void PerfContext::Reset() {
  ...
  delta_cache_hit_count = 0;
  delta_read_count = 0;
  delta_read_byte = 0;
  delta_read_time = 0;
  delta_checksum_time = 0;
  delta_decompress_time = 0;
...
std::string PerfContext::ToString(bool exclude_zero_counters) const {
  ...
  PERF_CONTEXT_OUTPUT(delta_cache_hit_count);
  PERF_CONTEXT_OUTPUT(delta_read_count);
  PERF_CONTEXT_OUTPUT(delta_read_byte);
  PERF_CONTEXT_OUTPUT(delta_read_time);
  PERF_CONTEXT_OUTPUT(delta_checksum_time);
  PERF_CONTEXT_OUTPUT(delta_decompress_time);
