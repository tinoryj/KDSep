...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {DELTA_DB_NUM_PUT, "rocksdb.deltadb.num.put"},
    {DELTA_DB_NUM_WRITE, "rocksdb.deltadb.num.write"},
    {DELTA_DB_NUM_GET, "rocksdb.deltadb.num.get"},
    {DELTA_DB_NUM_MULTIGET, "rocksdb.deltadb.num.multiget"},
    {DELTA_DB_NUM_SEEK, "rocksdb.deltadb.num.seek"},
    {DELTA_DB_NUM_NEXT, "rocksdb.deltadb.num.next"},
    {DELTA_DB_NUM_PREV, "rocksdb.deltadb.num.prev"},
    {DELTA_DB_NUM_KEYS_WRITTEN, "rocksdb.deltadb.num.keys.written"},
    {DELTA_DB_NUM_KEYS_READ, "rocksdb.deltadb.num.keys.read"},
    {DELTA_DB_BYTES_WRITTEN, "rocksdb.deltadb.bytes.written"},
    {DELTA_DB_BYTES_READ, "rocksdb.deltadb.bytes.read"},
    {DELTA_DB_WRITE_INLINED, "rocksdb.deltadb.write.inlined"},
    {DELTA_DB_WRITE_INLINED_TTL, "rocksdb.deltadb.write.inlined.ttl"},
    {DELTA_DB_WRITE_DELTA, "rocksdb.deltadb.write.delta"},
    {DELTA_DB_WRITE_DELTA_TTL, "rocksdb.deltadb.write.delta.ttl"},
    {DELTA_DB_DELTA_FILE_BYTES_WRITTEN,
     "rocksdb.deltadb.delta.file.bytes.written"},
    {DELTA_DB_DELTA_FILE_BYTES_READ, "rocksdb.deltadb.delta.file.bytes.read"},
    {DELTA_DB_DELTA_FILE_SYNCED, "rocksdb.deltadb.delta.file.synced"},
    {DELTA_DB_DELTA_INDEX_EXPIRED_COUNT,
     "rocksdb.deltadb.delta.index.expired.count"},
    {DELTA_DB_DELTA_INDEX_EXPIRED_SIZE,
     "rocksdb.deltadb.delta.index.expired.size"},
    {DELTA_DB_DELTA_INDEX_EVICTED_COUNT,
     "rocksdb.deltadb.delta.index.evicted.count"},
    {DELTA_DB_DELTA_INDEX_EVICTED_SIZE,
     "rocksdb.deltadb.delta.index.evicted.size"},
    {DELTA_DB_GC_NUM_FILES, "rocksdb.deltadb.gc.num.files"},
    {DELTA_DB_GC_NUM_NEW_FILES, "rocksdb.deltadb.gc.num.new.files"},
    {DELTA_DB_GC_FAILURES, "rocksdb.deltadb.gc.failures"},
    {DELTA_DB_GC_NUM_KEYS_OVERWRITTEN,
     "rocksdb.deltadb.gc.num.keys.overwritten"},
    {DELTA_DB_GC_NUM_KEYS_EXPIRED, "rocksdb.deltadb.gc.num.keys.expired"},
    {DELTA_DB_GC_NUM_KEYS_RELOCATED, "rocksdb.deltadb.gc.num.keys.relocated"},
    {DELTA_DB_GC_BYTES_OVERWRITTEN, "rocksdb.deltadb.gc.bytes.overwritten"},
    {DELTA_DB_GC_BYTES_EXPIRED, "rocksdb.deltadb.gc.bytes.expired"},
    {DELTA_DB_GC_BYTES_RELOCATED, "rocksdb.deltadb.gc.bytes.relocated"},
    {DELTA_DB_FIFO_NUM_FILES_EVICTED, "rocksdb.deltadb.fifo.num.files.evicted"},
    {DELTA_DB_FIFO_NUM_KEYS_EVICTED, "rocksdb.deltadb.fifo.num.keys.evicted"},
    {DELTA_DB_FIFO_BYTES_EVICTED, "rocksdb.deltadb.fifo.bytes.evicted"},
    ...
    {DELTA_DB_CACHE_MISS, "rocksdb.deltadb.cache.miss"},
    {DELTA_DB_CACHE_HIT, "rocksdb.deltadb.cache.hit"},
    {DELTA_DB_CACHE_ADD, "rocksdb.deltadb.cache.add"},
    {DELTA_DB_CACHE_ADD_FAILURES, "rocksdb.deltadb.cache.add.failures"},
    {DELTA_DB_CACHE_BYTES_READ, "rocksdb.deltadb.cache.bytes.read"},
    {DELTA_DB_CACHE_BYTES_WRITE, "rocksdb.deltadb.cache.bytes.write"}};
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {DELTA_DB_KEY_SIZE, "rocksdb.deltadb.key.size"},
    {DELTA_DB_VALUE_SIZE, "rocksdb.deltadb.value.size"},
    {DELTA_DB_WRITE_MICROS, "rocksdb.deltadb.write.micros"},
    {DELTA_DB_GET_MICROS, "rocksdb.deltadb.get.micros"},
    {DELTA_DB_MULTIGET_MICROS, "rocksdb.deltadb.multiget.micros"},
    {DELTA_DB_SEEK_MICROS, "rocksdb.deltadb.seek.micros"},
    {DELTA_DB_NEXT_MICROS, "rocksdb.deltadb.next.micros"},
    {DELTA_DB_PREV_MICROS, "rocksdb.deltadb.prev.micros"},
    {DELTA_DB_DELTA_FILE_WRITE_MICROS,
     "rocksdb.deltadb.delta.file.write.micros"},
    {DELTA_DB_DELTA_FILE_READ_MICROS, "rocksdb.deltadb.delta.file.read.micros"},
    {DELTA_DB_DELTA_FILE_SYNC_MICROS, "rocksdb.deltadb.delta.file.sync.micros"},
    {DELTA_DB_GC_MICROS, "rocksdb.deltadb.gc.micros"},
    {DELTA_DB_COMPRESSION_MICROS, "rocksdb.deltadb.compression.micros"},
    {DELTA_DB_DECOMPRESSION_MICROS, "rocksdb.deltadb.decompression.micros"},
