...
enum class CacheEntryRole {
  ...
  kBlobCache,
  // Delta value (when using the same cache as block cache and delta cache)
  kDeltaValue,
  // Delta cache's charge to account for its memory usage (when using a
  // separate block cache and delta cache)
  kDeltaCache,
