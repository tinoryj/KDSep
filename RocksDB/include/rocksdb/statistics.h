...
enum Tickers : uint32_t {
  ...
  // DeltaDB specific stats
  // # of Put/PutTTL/PutUntil to DeltaDB. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_PUT,
  // # of Write to DeltaDB. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_WRITE,
  // # of Get to DeltaDB. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_GET,
  // # of MultiGet to DeltaDB. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_MULTIGET,
  // # of Seek/SeekToFirst/SeekToLast/SeekForPrev to DeltaDB iterator. Only
  // applicable to legacy DeltaDB.
  DELTA_DB_NUM_SEEK,
  // # of Next to DeltaDB iterator. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_NEXT,
  // # of Prev to DeltaDB iterator. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_PREV,
  // # of keys written to DeltaDB. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_KEYS_WRITTEN,
  // # of keys read from DeltaDB. Only applicable to legacy DeltaDB.
  DELTA_DB_NUM_KEYS_READ,
  // # of bytes (key + value) written to DeltaDB. Only applicable to legacy
  // DeltaDB.
  DELTA_DB_BYTES_WRITTEN,
  // # of bytes (keys + value) read from DeltaDB. Only applicable to legacy
  // DeltaDB.
  DELTA_DB_BYTES_READ,
  // # of keys written by DeltaDB as non-TTL inlined value. Only applicable to
  // legacy DeltaDB.
  DELTA_DB_WRITE_INLINED,
  // # of keys written by DeltaDB as TTL inlined value. Only applicable to
  // legacy
  // DeltaDB.
  DELTA_DB_WRITE_INLINED_TTL,
  // # of keys written by DeltaDB as non-TTL delta value. Only applicable to
  // legacy DeltaDB.
  DELTA_DB_WRITE_DELTA,
  // # of keys written by DeltaDB as TTL delta value. Only applicable to legacy
  // DeltaDB.
  DELTA_DB_WRITE_DELTA_TTL,
  // # of bytes written to delta file.
  DELTA_DB_DELTA_FILE_BYTES_WRITTEN,
  // # of bytes read from delta file.
  DELTA_DB_DELTA_FILE_BYTES_READ,
  // # of times a delta files being synced.
  DELTA_DB_DELTA_FILE_SYNCED,
  // # of delta index evicted from base DB by DeltaDB compaction filter because
  // of expiration. Only applicable to legacy DeltaDB.
  DELTA_DB_DELTA_INDEX_EXPIRED_COUNT,
  // size of delta index evicted from base DB by DeltaDB compaction filter
  // because of expiration. Only applicable to legacy DeltaDB.
  DELTA_DB_DELTA_INDEX_EXPIRED_SIZE,
  // # of delta index evicted from base DB by DeltaDB compaction filter because
  // of corresponding file deleted. Only applicable to legacy DeltaDB.
  DELTA_DB_DELTA_INDEX_EVICTED_COUNT,
  // size of delta index evicted from base DB by DeltaDB compaction filter
  // because of corresponding file deleted. Only applicable to legacy DeltaDB.
  DELTA_DB_DELTA_INDEX_EVICTED_SIZE,
  // # of delta files that were obsoleted by garbage collection. Only applicable
  // to legacy DeltaDB.
  DELTA_DB_GC_NUM_FILES,
  // # of delta files generated by garbage collection. Only applicable to legacy
  // DeltaDB.
  DELTA_DB_GC_NUM_NEW_FILES,
  // # of DeltaDB garbage collection failures. Only applicable to legacy
  // DeltaDB.
  DELTA_DB_GC_FAILURES,
  // # of keys dropped by DeltaDB garbage collection because they had been
  // overwritten. DEPRECATED.
  DELTA_DB_GC_NUM_KEYS_OVERWRITTEN,
  // # of keys dropped by DeltaDB garbage collection because of expiration.
  // DEPRECATED.
  DELTA_DB_GC_NUM_KEYS_EXPIRED,
  // # of keys relocated to new delta file by garbage collection.
  DELTA_DB_GC_NUM_KEYS_RELOCATED,
  // # of bytes dropped by DeltaDB garbage collection because they had been
  // overwritten. DEPRECATED.
  DELTA_DB_GC_BYTES_OVERWRITTEN,
  // # of bytes dropped by DeltaDB garbage collection because of expiration.
  // DEPRECATED.
  DELTA_DB_GC_BYTES_EXPIRED,
  // # of bytes relocated to new delta file by garbage collection.
  DELTA_DB_GC_BYTES_RELOCATED,
  // # of delta files evicted because of DeltaDB is full. Only applicable to
  // legacy DeltaDB.
  DELTA_DB_FIFO_NUM_FILES_EVICTED,
  // # of keys in the delta files evicted because of DeltaDB is full. Only
  // applicable to legacy DeltaDB.
  DELTA_DB_FIFO_NUM_KEYS_EVICTED,
  // # of bytes in the delta files evicted because of DeltaDB is full. Only
  // applicable to legacy DeltaDB.
  DELTA_DB_FIFO_BYTES_EVICTED,
  ...
  // Integrated DeltaDB specific stats
  // # of times cache miss when accessing delta from delta cache.
  DELTA_DB_CACHE_MISS,
  // # of times cache hit when accessing delta from delta cache.
  DELTA_DB_CACHE_HIT,
  // # of data blocks added to delta cache.
  DELTA_DB_CACHE_ADD,
  // # of failures when adding deltas to delta cache.
  DELTA_DB_CACHE_ADD_FAILURES,
  // # of bytes read from delta cache.
  DELTA_DB_CACHE_BYTES_READ,
  // # of bytes written into delta cache.
  DELTA_DB_CACHE_BYTES_WRITE,
...
enum Histograms : uint32_t {
  ...
  // deltaDB specific stats
  // Size of keys written to deltaDB. Only applicable to legacy deltaDB.
  DELTA_DB_KEY_SIZE,
  // Size of values written to deltaDB. Only applicable to legacy deltaDB.
  DELTA_DB_VALUE_SIZE,
  // deltaDB Put/PutWithTTL/PutUntil/Write latency. Only applicable to legacy
  // deltaDB.
  DELTA_DB_WRITE_MICROS,
  // deltaDB Get latency. Only applicable to legacy deltaDB.
  DELTA_DB_GET_MICROS,
  // deltaDB MultiGet latency. Only applicable to legacy deltaDB.
  DELTA_DB_MULTIGET_MICROS,
  // deltaDB Seek/SeekToFirst/SeekToLast/SeekForPrev latency. Only applicable to
  // legacy deltaDB.
  DELTA_DB_SEEK_MICROS,
  // deltaDB Next latency. Only applicable to legacy deltaDB.
  DELTA_DB_NEXT_MICROS,
  // deltaDB Prev latency. Only applicable to legacy deltaDB.
  DELTA_DB_PREV_MICROS,
  // delta file write latency.
  DELTA_DB_DELTA_FILE_WRITE_MICROS,
  // delta file read latency.
  DELTA_DB_DELTA_FILE_READ_MICROS,
  // delta file sync latency.
  DELTA_DB_DELTA_FILE_SYNC_MICROS,
  // deltaDB garbage collection time. DEPRECATED.
  DELTA_DB_GC_MICROS,
  // deltaDB compression time.
  DELTA_DB_COMPRESSION_MICROS,
  // deltaDB decompression time.
