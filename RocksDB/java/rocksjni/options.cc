...
/*
 * Class:     org_rocksdb_Options
 * Method:    setEnableDeltaFiles
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setEnableDeltaFiles(JNIEnv*, jobject,
                                                  jlong jhandle,
                                                  jboolean jenable_blob_files) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->enable_delta_files = static_cast<bool>(jenable_delta_files);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    enableDeltaFiles
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_enableDeltaFiles(JNIEnv*, jobject,
                                                   jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jboolean>(opts->enable_delta_files);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setMinDeltaSize
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setMinDeltaSize(JNIEnv*, jobject, jlong jhandle,
                                              jlong jmin_delta_size) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->min_delta_size = static_cast<uint64_t>(jmin_delta_size);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_minDeltaSize(JNIEnv*, jobject, jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jlong>(opts->min_delta_size);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setDeltaFileSize
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setDeltaFileSize(JNIEnv*, jobject, jlong jhandle,
                                               jlong jdelta_file_size) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->delta_file_size = static_cast<uint64_t>(jdelta_file_size);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    deltaFileSize
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_deltaFileSize(JNIEnv*, jobject, jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jlong>(opts->delta_file_size);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setDeltaCompressionType
 * Signature: (JB)V
 */
void Java_org_rocksdb_Options_setDeltaCompressionType(
    JNIEnv*, jobject, jlong jhandle, jbyte jdelta_compression_type_value) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->delta_compression_type =
      ROCKSDB_NAMESPACE::CompressionTypeJni::toCppCompressionType(
          jdelta_compression_type_value);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    deltaCompressionType
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_Options_deltaCompressionType(JNIEnv*, jobject,
                                                    jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return ROCKSDB_NAMESPACE::CompressionTypeJni::toJavaCompressionType(
      opts->delta_compression_type);
...
/*
 * Class:     org_rocksdb_Options
 * Method:    setEnableDeltaGarbageCollection
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setEnableDeltaGarbageCollection(
    JNIEnv*, jobject, jlong jhandle,
    jboolean jenable_delta_garbage_collection) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->enable_delta_garbage_collection =
      static_cast<bool>(jenable_delta_garbage_collection);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    enableDeltaGarbageCollection
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_enableDeltaGarbageCollection(JNIEnv*, jobject,
                                                               jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jboolean>(opts->enable_delta_garbage_collection);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setDeltaGarbageCollectionAgeCutoff
 * Signature: (JD)V
 */
void Java_org_rocksdb_Options_setDeltaGarbageCollectionAgeCutoff(
    JNIEnv*, jobject, jlong jhandle,
    jdouble jdelta_garbage_collection_age_cutoff) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->delta_garbage_collection_age_cutoff =
      static_cast<double>(jdelta_garbage_collection_age_cutoff);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    deltaGarbageCollectionAgeCutoff
 * Signature: (J)D
 */
jdouble Java_org_rocksdb_Options_deltaGarbageCollectionAgeCutoff(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jdouble>(opts->delta_garbage_collection_age_cutoff);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setDeltaGarbageCollectionForceThreshold
 * Signature: (JD)V
 */
void Java_org_rocksdb_Options_setDeltaGarbageCollectionForceThreshold(
    JNIEnv*, jobject, jlong jhandle,
    jdouble jdelta_garbage_collection_force_threshold) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->delta_garbage_collection_force_threshold =
      static_cast<double>(jdelta_garbage_collection_force_threshold);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    deltaGarbageCollectionForceThreshold
 * Signature: (J)D
 */
jdouble Java_org_rocksdb_Options_deltaGarbageCollectionForceThreshold(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jdouble>(opts->delta_garbage_collection_force_threshold);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setDeltaCompactionReadaheadSize
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setDeltaCompactionReadaheadSize(
    JNIEnv*, jobject, jlong jhandle, jlong jdelta_compaction_readahead_size) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->delta_compaction_readahead_size =
      static_cast<uint64_t>(jdelta_compaction_readahead_size);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    deltaCompactionReadaheadSize
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_deltaCompactionReadaheadSize(JNIEnv*, jobject,
                                                            jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jlong>(opts->delta_compaction_readahead_size);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setDeltaFileStartingLevel
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setDeltaFileStartingLevel(
    JNIEnv*, jobject, jlong jhandle, jint jdelta_file_starting_level) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->delta_file_starting_level = jdelta_file_starting_level;
}

/*
 * Class:     org_rocksdb_Options
 * Method:    deltaFileStartingLevel
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_deltaFileStartingLevel(JNIEnv*, jobject,
                                                     jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jint>(opts->delta_file_starting_level);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setPrepopulateDeltaCache
 * Signature: (JB)V
 */
void Java_org_rocksdb_Options_setPrepopulateDeltaCache(
    JNIEnv*, jobject, jlong jhandle, jbyte jprepopulate_delta_cache_value) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->prepopulate_delta_cache =
      ROCKSDB_NAMESPACE::PrepopulateDeltaCacheJni::toCppPrepopulateDeltaCache(
          jprepopulate_delta_cache_value);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    prepopulateDeltaCache
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_Options_prepopulateDeltaCache(JNIEnv*, jobject,
                                                     jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return ROCKSDB_NAMESPACE::PrepopulateDeltaCacheJni::
      toJavaPrepopulateDeltaCache(opts->prepopulate_delta_cache);
}
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setEnableDeltaFiles(
    JNIEnv*, jobject, jlong jhandle, jboolean jenable_delta_files) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->enable_delta_files = static_cast<bool>(jenable_delta_files);
}
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_ColumnFamilyOptions_enableDeltaFiles(JNIEnv*, jobject,
                                                               jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jboolean>(opts->enable_delta_files);
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setMinDeltaSize(
    JNIEnv*, jobject, jlong jhandle, jlong jmin_delta_size) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->min_delta_size = static_cast<uint64_t>(jmin_delta_size);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_ColumnFamilyOptions_minDeltaSize(JNIEnv*, jobject,
                                                        jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jlong>(opts->min_delta_size);
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDeltaFileSize(
    JNIEnv*, jobject, jlong jhandle, jlong jdelta_file_size) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->delta_file_size = static_cast<uint64_t>(jdelta_file_size);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_ColumnFamilyOptions_deltaFileSize(JNIEnv*, jobject,
                                                         jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jlong>(opts->delta_file_size);
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDeltaCompressionType(
    JNIEnv*, jobject, jlong jhandle, jbyte jdelta_compression_type_value) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->delta_compression_type =
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_ColumnFamilyOptions_deltaCompressionType(JNIEnv*,
                                                                jobject,
                                                                jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setEnableDeltaGarbageCollection(
    JNIEnv*, jobject, jlong jhandle,
    jboolean jenable_delta_garbage_collection) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_ColumnFamilyOptions_enableDeltaGarbageCollection(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jboolean>(opts->enable_delta_garbage_collection);
 ...
 * Signature: (JD)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDeltaGarbageCollectionAgeCutoff(
    JNIEnv*, jobject, jlong jhandle,
    jdouble jdelta_garbage_collection_age_cutoff) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
 ...
 * Signature: (J)D
 */
jdouble Java_org_rocksdb_ColumnFamilyOptions_deltaGarbageCollectionAgeCutoff(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jdouble>(opts->delta_garbage_collection_age_cutoff);
 ...
 * Signature: (JD)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDeltaGarbageCollectionForceThreshold(
    JNIEnv*, jobject, jlong jhandle,
    jdouble jdelta_garbage_collection_force_threshold) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
 ...
 */
jdouble
Java_org_rocksdb_ColumnFamilyOptions_deltaGarbageCollectionForceThreshold(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jdouble>(opts->delta_garbage_collection_force_threshold);
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDeltaCompactionReadaheadSize(
    JNIEnv*, jobject, jlong jhandle, jlong jdelta_compaction_readahead_size) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->delta_compaction_readahead_size =
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_ColumnFamilyOptions_deltaCompactionReadaheadSize(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jlong>(opts->delta_compaction_readahead_size);
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDeltaFileStartingLevel(
    JNIEnv*, jobject, jlong jhandle, jint jdelta_file_starting_level) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->delta_file_starting_level = jdelta_file_starting_level;
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_ColumnFamilyOptions_deltaFileStartingLevel(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jint>(opts->delta_file_starting_level);
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setPrepopulateDeltaCache(
    JNIEnv*, jobject, jlong jhandle, jbyte jprepopulate_delta_cache_value) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  opts->prepopulate_delta_cache =
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_ColumnFamilyOptions_prepopulateDeltaCache(
    JNIEnv*, jobject, jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return ROCKSDB_NAMESPACE::PrepopulateDeltaCacheJni::
