...
HashStoreInterface::HashStoreInterface(KDSepOptions* options, const string& workingDirStr, HashStoreFileManager*& hashStoreFileManager, HashStoreFileOperator*& hashStoreFileOperator, messageQueue<writeBackObject*>* writeBackOperationsQueue)
{
...
//		debug_error("real flush file %lu\n", it->file_id);
        ...
        StatsRecorder::getInstance()->timeProcess(StatsType::KDSep_HASHSTORE_SYNC, tv);
