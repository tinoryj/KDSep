...
HashStoreFileOperator::HashStoreFileOperator(KDSepOptions* options, string workingDirStr, HashStoreFileManager* hashStoreFileManager)
{
        ...
        write_buf_size, uint64_t contentObjectNumber, bool need_flush)
{
    ...
    STAT_PROCESS(status_w = file_hdl->file_op_ptr->writeFile(write_buf,
                write_buf_size), StatsType::KDSep_HASHSTORE_PUT_IO_TRAFFIC);
