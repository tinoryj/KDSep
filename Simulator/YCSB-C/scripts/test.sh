...
#                                    fi
                                    ...
                                    if [[ "$runMode" == "raw" ]]; then
                                        scripts/run.sh $runMode req${req} op${op} fc${fc} fl${fl} sst${sst} memtable${memtable} l1sz${l1sz} \
                                            cache$cacheSize \
...
#indexSet=(5) fcs=(10 20 40 80 160 320 640) rreqs=("100M" "50M" "25M" "13M" "6M" "4M" "2M") runModeSet=('bkv' 'raw' 'kv') for 
