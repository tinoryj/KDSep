...
../../rocksdb-7.7.3/ldb manifest_dump --path=$manifestFile > ${runningCount}/manifest.log
...
for SSTable in ${sstablesSet[@]}; do
    ...
    ../../rocksdb-7.7.3/sst_dump --file=$SSTable --output_hex --command=scan >> ${runningCount}/tmp/$SSTFileName.log
